...
PRODUCT_COPY_FILES := \
    vendor/dell/gallo/proprietary/lib/libaudio.so:obj/lib/libaudio.so \
    vendor/dell/gallo/proprietary/lib/libaudiopolicy.so:obj/lib/libaudiopolicy.so \
    vendor/dell/gallo/proprietary/lib/libcamera.so:obj/lib/libcamera.so \

PRODUCT_COPY_FILES += \
    vendor/dell/gallo/proprietary/lib/libaudio.so:system/lib/libaudio.so \
    vendor/dell/gallo/proprietary/lib/libaudiopolicy.so:system/lib/libaudiopolicy.so \
    ...
    vendor/dell/gallo/proprietary/etc/audio_policy.conf:system/etc/audio_policy.conf \
    vendor/dell/gallo/proprietary/etc/media_profiles.xml:system/etc/media_profiles.xml \
    vendor/dell/gallo/proprietary/etc/media_codecs.xml:system/etc/media_codecs.xml \
    vendor/dell/gallo/proprietary/etc/mixer_paths.xml:system/etc/mixer_paths.xml \
    ...
    vendor/cm/sepolicy/mac_permissions.xml:system/etc/security/mac_permissions.xml \
